...
service.youzyEpt = function (data) {
    ...
    var aesCtr = new aesjs.ModeOfOperation.ctr(service.aesKey(), new aesjs.Counter(5));
...
service.decrypt = function (data) {
    ...
    var encryptedBytes = youzyEptService.utils.hex.toBytes(data);
    var aesCtr = new youzyEptService.ModeOfOperation.ctr(tzyCollegeFirst.aesKey(), new youzyEptService.Counter(5));
    var decryptedBytes = aesCtr.decrypt(encryptedBytes);
    var decryptedText = youzyEptService.utils.utf8.fromBytes(decryptedBytes);
...
//////////////////tzyMajorFirst.service.js/////////////////////////////
var tzyMajorFirst = {};
tzyMajorFirst.aesKeyMon = function () {
    var key = [46, 67, 9, 9, 10, 11];
    return key.concat(tzyManualFill.aesKeyMon());
};

tzyMajorFirst.aesKey = function () {
    var key = [46, 67, 8, 9, 10, 11];
    return key.concat(tzyManualFill.aesKeySat());
};

tzyMajorFirst.aesKeyTus = function () {
    var key = [46, 67, 8, 11, 10, 11];
    return key.concat(tzyManualFill.aesKeyTus());
};


////////////////////tzyManualFill.service.js////////////////
var tzyManualFill = {};

tzyManualFill.aesKeyFri = function () {
    return [46, 67, 8, 9, 10, 11];
};

tzyManualFill.aesKeySat = function () {
    return [12, 13, 14, 15, 16];
};

tzyManualFill.aesKey = function () {
    return [46, 67, 8, 9, 10, 11];
};
